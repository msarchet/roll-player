...
const About = () => (
  <div className={styles.about}>
    <p>
      ...
      <span>
        <a href="http://github.com/msarchet/roll-player">
        <FontAwesome name='github' style={{paddingRight: '5px'}}/>Github</a>
      </span>
    </p>
    <p>
    ...
    <p>
      <FontAwesome name='twitter-square' style={{color: '#00aced', paddingRight: '5px'}}/>
      <a href="http://twitter.com/msarchet">@msarchet</a>
    </p>
    <p>
